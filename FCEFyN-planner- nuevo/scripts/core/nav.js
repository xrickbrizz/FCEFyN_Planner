...
export const ICONS = {
  ...
  planificador: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Planificador"><title>Planificador</title><rect x="3.8" y="4" width="16.4" height="16.4" rx="2"/><path d="M3.8 8.2h16.4"/><path d="M8 3.4v2.1"/><path d="M16 3.4v2.1"/><path d="M7.2 11.2h4.6"/><path d="M7.2 14.2h4.6"/><path d="M7.2 17.2h2.8"/><rect x="13.2" y="10.6" width="4.2" height="7.2" rx=".8"/><path d="M14.1 13l1.1 1.1 1.5-1.8"/></svg>`,
